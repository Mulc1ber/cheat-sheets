...
const config: Config = {
  title: "CheatSheets",
  tagline: "CheatSheets for developers",
  ...
  url: process.env.DOCUSAURUS_URL || "https://mulc1ber.github.io/",
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: process.env.DOCUSAURUS_BASE_URL || "/cheat-sheets/",
